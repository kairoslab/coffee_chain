import { PermissionResponse } from '../../expo-modules-core/build';
 ...
 * ```
 */
export declare const useCameraPermissions: (options?: import("../../expo-modules-core/build").PermissionHookOptions<object> | undefined) => [PermissionResponse | null, () => Promise<PermissionResponse>, () => Promise<PermissionResponse>];
/**
 ...
 * ```
 */
export declare const useMicrophonePermissions: (options?: import("../../expo-modules-core/build").PermissionHookOptions<object> | undefined) => [PermissionResponse | null, () => Promise<PermissionResponse>, () => Promise<PermissionResponse>];
/**
