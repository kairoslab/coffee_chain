import { useRouteInfo } from 'expo-router/build/global-state/router-store';
import { Router } from 'expo-router/build/imperative-api';
import { RouteParams, RouteSegments, UnknownOutputParams, Route } from 'expo-router/build/types';
export { useRouteInfo };
/**
...
export declare function useRootNavigationState(): Readonly<{
    ...
    routeNames: string[];
    history?: unknown[];
    routes: import("../../@react-navigation/native/lib/typescript/src").NavigationRoute<import("../../@react-navigation/native/lib/typescript/src").ParamListBase, string>[];
    type: string;
    stale: false;
}>;
/**
 ...
 */
export declare function useRootNavigation(): import("../../@react-navigation/native/lib/typescript/src").NavigationContainerRef<ReactNavigation.RootParamList> | null;
/**
 ...
 */
export declare function useNavigationContainerRef(): import("../../@react-navigation/native/lib/typescript/src").NavigationContainerRefWithCurrent<ReactNavigation.RootParamList>;
/**
 *
