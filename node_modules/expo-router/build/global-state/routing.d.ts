import { NavigationAction, type NavigationState, PartialRoute, type PartialState, type NavigationContainerRef, ParamListBase } from '../../../@react-navigation/native/lib/typescript/src';
import { type RefObject } from 'react';
import { ResultState } from 'expo-router/build/fork/getStateFromPath';
import { Href } from 'expo-router/build/types';
import { SingularOptions } from 'expo-router/build/useScreens';
...
export declare function findDivergentState(_actionState: ResultState, _navigationState: NavigationState, lookThroughAllTabs?: boolean): {
    actionState: PartialState<Readonly<{
        ...
        routeNames: string[];
        history?: unknown[];
        routes: import("../../../@react-navigation/native/lib/typescript/src").NavigationRoute<ParamListBase, string>[];
        type: string;
        stale: false;
    }>>;
    ...
    navigationRoutes: import("../../../@react-navigation/native/lib/typescript/src").NavigationRoute<ParamListBase, string>[];
};
